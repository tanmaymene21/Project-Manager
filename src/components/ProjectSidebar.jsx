...
const ProjectSidebar = ({ onStartAddProject, projects, onSelectProject, selectedProjectId }) => {
  return (
    <aside className='px-8 py-16 w-1/3 md:w-72 bg-stone-900 text-stone-50 rounded-md'>
      <h2 className='text-stone-200 font-bold uppercase md:text- mb-8'>Your Projects</h2>
      <div className="">
